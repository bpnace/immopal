      ...
      <div className="max-w-6xl mx-auto space-y-12">
          ...
          <aside className="lg:col-span-7 space-y-6 lg:sticky lg:top-24">
            ...
            <section className="bg-card border border-border rounded-xl p-6 md:p-7 space-y-4">
              ...
              <p className="text-muted-foreground">
                So läuft die kostenlose Immobilienbewertung ab
              </p>
        ...
        <section className="space-y-6">
          <div className="space-y-3 text-muted-foreground leading-relaxed">
            <p>
              Wenn man eine Immobilie besitzt, kommt irgendwann die Frage auf: Was ist sie heute
              eigentlich wert? Ob Verkauf, Erbe oder einfach zur Orientierung – eine realistische
              Einschätzung hilft bei jeder Entscheidung.
            </p>
            <p>
              Wir bieten Ihnen eine kostenlose Immobilienbewertung für Wohnungen und Häuser in
              Berlin und Brandenburg. Persönlich, nachvollziehbar und ohne Verpflichtungen.
            </p>
          </div>
          ...
          <div className="space-y-3">
            ...
            <p className="text-muted-foreground leading-relaxed">
              Der Immobilienmarkt verändert sich ständig. Angebotspreise, Nachfrage und regionale
              Unterschiede können den tatsächlichen Wert einer Immobilie deutlich beeinflussen. Eine
              professionelle Immobilienbewertung schafft Klarheit und hilft, fundierte
              Entscheidungen zu treffen unabhängig davon, ob ein Verkauf unmittelbar geplant ist
              oder nicht.
            </p>
            <p className="text-muted-foreground leading-relaxed">
              Unsere Bewertung basiert nicht nur auf automatisierten Rechnern, sondern auch auf
              realen Marktdaten, tatsächlich erzielten Verkaufspreisen und einer individuellen
              Betrachtung Ihrer Immobilie. So entsteht eine Einschätzung, die realistisch,
          ...
          <div className="space-y-3">
            <h2 className="text-2xl md:text-3xl font-semibold">
              Ehrlich. Persönlich. Ohne Verkaufsdruck.
            </h2>
            <p className="text-muted-foreground leading-relaxed">
              Wir legen großen Wert auf Transparenz und Fairness. Deshalb sagen wir Ihnen auch
              offen, ob ein Verkauf aktuell keinen Sinn ergibt oder ein anderes Vorgehen sinnvoller
              ist.
            </p>
            <ul className="list-disc pl-5 space-y-2 text-muted-foreground">
          ...
          <div className="space-y-3">
            ...
            <p className="text-muted-foreground leading-relaxed">
              Unsere Bewertungen berücksichtigen die Besonderheiten des jeweiligen Standorts. Von
              der Mikrolage über die Nachfrage bis hin zur aktuellen Marktentwicklung. Das ist
              besonders entscheidend, da sich Immobilienpreise je nach Stadtteil, Umgebung und
              Nutzung stark unterscheiden können.
            </p>
            <p className="text-muted-foreground leading-relaxed">
              Sie erhalten eine fundierte Einschätzung, die Ihnen als verlässliche
              Entscheidungsgrundlage dient, ganz gleich, ob es um Verkauf, Vermögensplanung,
              Erbschaft oder Finanzierung geht.
            </p>
          </div>
        </section>
