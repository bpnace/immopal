...
export function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 bg-[#25D366] text-white rounded-full p-4 shadow-lg hover:shadow-xl transition-all hover:scale-110 animate-pulse hover:animate-none group"
